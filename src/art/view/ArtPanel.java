...
private static final Integer MINIMUM_SCALE = null;
private static final int MINIUMUM_EDGE = 0;
private final int MINIMUM_EDGE = 5;
private final int MAXIMUM_EDGE = 20;
private final int MINIUM_SCALE = 20;
...
public ArtPanel(ArtController app)
{
	...
	edgeSlider = new JSlider(MINIUMUM_EDGE, MAXIMUM_EDGE);
	...
	ellipseButton = new JButton("add polygon");
	polygonButton = new JButton("clear image");
	clearButton = new JButton("save image");
